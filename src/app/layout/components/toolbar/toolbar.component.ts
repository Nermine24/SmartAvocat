...
group: any;
    ...
    logout() {
        this.token.signOut();
        window.location.href='http://localhost:4200/pages/auth/login-2';
      }
      profile() {
     
        window.location.href='http://localhost:4200/pages/profile';
      }
