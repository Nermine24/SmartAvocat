                ...
                if (this.role === "Client")
{
           ...
           this._fuseNavigationService.updateNavigationItem('search-modern', {
            hidden: true
        });
           // Update the calendar menu item
           this._fuseNavigationService.updateNavigationItem('full-width-tabbed-1', {
               hidden: true
           });
}
else {
    ...
    this._fuseNavigationService.updateNavigationItem('cards', {
     hidden: true
 });
}
